...
<head>
  ...
  <title>Documantation | User</title>
  <?php
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <?php
                  ...
                  $nomor  = 1;
                  $user  = $_SESSION['email'];
                  $sql    = "SELECT * FROM user WHERE email = '$user' ORDER BY id DESC";
                  ...
                  if(mysqli_num_rows($result)>0){// jika nggak ada datanya maka while tidak di jalankan
                    while ($row = mysqli_fetch_assoc($result)) {// untuk memunculkan dalam bentuk rapi, mengambil dan dijadikan erray associative
                      ...
                      <tr>
                        ...
                        <td>".$row['nama']."</td>
                        <td>".$row['email']."</td>                        <td>
                          <a href='edit_user.php?id=".$row['id']."' class='btn btn-primary btn-x5'>Edit</a> |
                          <a href='hapus_user.php?id=".$row['id']."' class='btn btn-danger btn-x5' onclick='javascript:return confirm(\"Apakah anda yakin ingin menghapus data ini?\")'>Hapus</a>
                        </td>
                      </tr>
                      ";
                    }
