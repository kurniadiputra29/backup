...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            $ID     = $_GET['id'];
            $sql    = "SELECT * from surat_masuk where id_masuk=$ID";
            ...
            <form class="form-horizontal" action="proses_edit.php" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="date" name="masuk" id="masuk" style="margin-top: 5px;" value="<?php echo $row['masuk']; ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="dari" class="form-control" id="dari" placeholder="Asal Surat" required value="<?php echo $row['dari']; ?> ">
                  </div>
                </div>
                <div class="form-group">
