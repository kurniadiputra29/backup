  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="box-header with-border">
              ...
              <a href="create_user.php" class="btn btn-primary pull-right">Create</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  if(mysqli_num_rows($result)>0){// jika nggak ada datanya maka while tidak di jalankan
                    while ($row = mysqli_fetch_assoc($result)) {// untuk memunculkan dalam bentuk rapi, mengambil dan dijadikan erray associative
                      ...
                      <tr>
                        ...
                        <td>".$row['nama']."</td>
                        <td>".$row['email']."</td>
                        <td>".'<img style="width: 100px; height: 100px" src="../foto_user/'.$row['foto']. ' " />'."</td>
                        <td>
                          <a href='edit_user.php?id=".$row['id_user']."' class='btn btn-primary btn-x5'>Edit</a> |
                          <a href='hapus_user.php?id=".$row['id_user']."' class='btn btn-danger btn-x5' onclick='javascript:return confirm(\"Apakah anda yakin ingin menghapus data ini?\")'>Hapus</a>
                        </td>
                      </tr>
                      ";
                    }
