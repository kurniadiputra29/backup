            ...
            <form class="form-horizontal" action="proses_edit.php" method="POST" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama" class="form-control" id="inputEmail3" value="<?php echo $row['nama']; ?>" required>
                  </div>
              </div>
              <div class="form-group">
                  ...
                  <div class="col-sm-10 radio">
                    <label>
                      <input type="radio" name="type" id="type" value="1" <?php if ($row['type']=="1"){echo "checked";}?>>
                      Peralatan
                    </label>
                  </div>
                  ...
                  <div class="col-sm-10 radio">
                    <label>
                      <input type="radio" name="type" id="type" value="0" <?php if ($row['type']=="0"){echo "checked";}?>>
                      Perlengkapan
                    </label>
                  </div>
                </div>
