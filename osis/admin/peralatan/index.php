...
<head>
  ...
  <title>OSIS | Peralatan & Perlengkapan</title>
  <?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Peralatan & Perlengkapan</li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Peralatan & Perlengkapan</h3>
               <div class="box-tools">
                <a href="create.php" class="btn btn-primary pull-right">Input Data</a>
              </div>
            </div>
                  ...
                  if(mysqli_num_rows($result)>0){// jika nggak ada datanya maka while tidak di jalankan
                    while ($row = mysqli_fetch_assoc($result)) {// untuk memunculkan dalam bentuk rapi, mengambil dan dijadikan erray associative
                      ...
                      <tr>
                        <td>".$nomor++."</td>
                        <td>".$row['nama']."</td>
                        <td>".peralatan($row['type'])."</td>
                        <td>
                          <a href='edit.php?id=".$row['id_peralatan']."' class='btn btn-primary btn-x5'>Edit</a> |
                          <a href='hapus.php?id=".$row['id_peralatan']."' class='btn btn-danger btn-x5' onclick='javascript:return confirm(\"Apakah anda yakin ingin menghapus data ini?\")'>Hapus</a>
                        </td>
                      </tr>
                      ";
                    }
