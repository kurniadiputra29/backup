            ...
            <div class="box-header with-border">
              <h3 class="box-title">Role</h3>
               <div class="box-tools">
                ...
                <a href="create_role.php" class="btn btn-primary pull-right">Create</a>
                <a href="http://localhost/osis/admin/role/index_role.php" class="btn btn-primary pull-right">Clear</a>
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <?php
                  ...
                  $sql    = "SELECT id_role, nama FROM role WHERE nama LIKE '%$cari%'";
                  ...
                  if(mysqli_num_rows($result)>0){// jika nggak ada datanya maka while tidak di jalankan
                    while ($row = mysqli_fetch_assoc($result)) {// untuk memunculkan dalam bentuk rapi, mengambil dan dijadikan erray associative
                      ...
                      <tr>
                        ...
                        <td>".$row['nama']."</td>
                        <td>
                          <a href='edit_role.php?id=".$row['id_role']."' class='btn btn-primary btn-x5'>Edit</a> |
                          <a href='hapus_role.php?id=".$row['id_role']."' class='btn btn-danger btn-x5' onclick='javascript:return confirm(\"Apakah anda yakin ingin menghapus data ini?\")'>Hapus</a>
                        </td>
                      </tr>
                      ";
                    }
