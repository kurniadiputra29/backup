  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          <div class="box">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" action="proses_create_role.php" method="POST" enctype="multipart/form-data"> <!--untuk inputan file harus di kasih enctype="multipart/form-data"-->
              <div class="box-body">
                <div class="form-group">
                  <label for="title" class="col-sm-2 control-label">Nama</label>
                  <div class="col-sm-10">
                    <input type="text" name="nama" class="form-control" id="title" placeholder="Title" required>
                  </div>
                </div>
              </div><!--box-body-->
              <!-- /.box-body -->
              <div class="box-footer">
                <a href="index_role.php" class="btn btn-default">Cancel</a>
