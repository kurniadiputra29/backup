            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <?php
                  ...
                  $nomor  = 1;
                  $sql    = "SELECT * FROM keuangan_internal ";
                  ...
                  if(mysqli_num_rows($result)>0){// jika nggak ada datanya maka while tidak di jalankan
                    while ($row = mysqli_fetch_assoc($result)) {// untuk memunculkan dalam bentuk rapi, mengambil dan dijadikan erray associative
                      ...
                      <tr>
                        ...
                        <td>
                          <a href='edit.php?id=".$row['id_internal']."' class='btn btn-primary btn-x5'>Edit</a> |
                          <a href='hapus.php?id=".$row['id_internal']."' class='btn btn-danger btn-x5' onclick='javascript:return confirm(\"Apakah anda yakin ingin menghapus data ini?\")'>Hapus</a>
                        </td>
                      </tr>
                      ";
                    }
