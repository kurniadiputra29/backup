...
class UserController extends Controller
{
    ...
    public function jsonUser(Request $request){
        ...
        ->addColumn('action', function ($index) {
            return '<form action="'. route('user.destroy', $index->id) .'" method="POST" class="text-center">
            <a href="' . route('user.edit', $index->id) . '" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-edit"></i>Edit</a>
